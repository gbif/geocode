...
function import_natural_earth() {
	...
	cd /var/tmp/import
	curl -# -O http://download.gbif.org/2019/04/ne_10m_admin_0_countries.zip
	#curl -# -O https://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_countries.zip
	curl -# -O http://download.gbif.org/2019/04/ne_10m_admin_0_map_units.zip
	#curl -# -O https://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_map_units.zip
	curl -# -O http://download.gbif.org/2019/04/ne_10m_admin_0_map_subunits.zip
	#curl -# -O http://download.gbif.org/2019/04/ne_10m_admin_1_states_provinces.zip
	mkdir -p ne
...
function import_marine_regions() {
	...
	mkdir -p /var/tmp/import
	cd /var/tmp/import
	curl -# -O http://download.gbif.org/2019/04/World_EEZ_v10_20180221.zip
	mkdir -p eez
